...
export default function Feature() {
  return (
    <div className="mt-16">
      <h1 className='text-[24px] text-[#111] py-2'>Featured</h1>
      <div className="
        md:grid-cols-2
        grid grid-cols-1 gap-4 text-white text-[20px] mt-5
        ">
        <div className="relative">
          <img src={feature1} alt="" className="object-none object-center min-h-[500px]"/>
        ...
        <div className="relative">
          <img src={feature2} alt="" className="object-none object-center min-h-[500px]" />
          <div className="absolute left-10 bottom-10">
            <h1 className="mb-5 stroke-black">Dominate Your Workouts in Metcon 8</h1>
